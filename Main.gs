...
//                                                                                         
//                                                                                                                     
//  from original code by louisthomas.pro
//  original contact : louisthomas.pro@gmail.com
//  original project : https://gitlab.com/louisthomaspro/carnet-de-suivi-dii.git
//
//  modified by lucaslepen2003@gmail.com
//  modified project : 
...
var CONSTANTS = {
  version: "1.2.0",
  files: {
    // template: '1SKabJkPDKdWfKwGBJrqdd9bJe_yr50DatJJ6wPH8upQ', // OLD TEMPLATE
    template: '1B45Vf1J0u_ICeZy5BmPGWe78_emFUgIcs8pu0cNTXrw',
    //table: '18FDN1lCA1RRYVE8JMBIOBuzQaJK8y6tYKsCl58opfyI' //OLD TABLE
    table: '1Osv9B_v_sWnTmFMrSbvSD5zTxm3dl3BVhDLaAXkAjKU'
  }
}
...
function onOpen() {
  ...
  .createMenu('Carnet de suivi ISIE Polytech') // Add a new option in the Google Sheets Add-ons Menu
